    ...
    <div class="container">
        <div class="group">
            ...
            <div class="group--content">
                <?php
                $con = mysqli_connect($hostname, $username, $password, $database);
                $query = mysqli_query($con, "SELECT id, content_text, color FROM content WHERE user_id = '" . $_SESSION["isLogged"] . "' AND group_id = '0';");
        ...
        <div class="group">
            ...
            <div class="group--content">
                <?php
                $con = mysqli_connect($hostname, $username, $password, $database);
                $query = mysqli_query($con, "SELECT id, content_text, color FROM content WHERE user_id = '" . $_SESSION["isLogged"] . "' AND group_id = '1';");
                while ($row = mysqli_fetch_assoc($query)) {
                    echo "<div class='group--task' style='background-color: ".$row["color"]. ";'><span>" . $row["content_text"] . "</span><div class='task--manage' db_id='" . $row["id"] . "'>+</div></div>";
                }
                mysqli_close($con);
        ...
        <div class="group">
            ...
            <div class="group--content">
                <?php
                $con = mysqli_connect($hostname, $username, $password, $database);
                $query = mysqli_query($con, "SELECT id, content_text, color FROM content WHERE user_id = '" . $_SESSION["isLogged"] . "' AND group_id = '2';");
                while ($row = mysqli_fetch_assoc($query)) {
                    echo "<div class='group--task' style='background-color: ".$row["color"]. ";'><span>" . $row["content_text"] . "</span><div class='task--manage' db_id='" . $row["id"] . "'>+</div></div>";
                }
                mysqli_close($con);
        ...
        <div class="group">
            ...
            <div class="group--content">
                <?php
                $con = mysqli_connect($hostname, $username, $password, $database);
                $query = mysqli_query($con, "SELECT id, content_text, color FROM content WHERE user_id = '" . $_SESSION["isLogged"] . "' AND group_id = '3';");
                while ($row = mysqli_fetch_assoc($query)) {
                    echo "<div class='group--task' style='background-color: ".$row["color"]. ";'><span>" . $row["content_text"] . "</span><div class='task--manage' db_id='" . $row["id"] . "'>+</div></div>";
                }
                mysqli_close($con);
